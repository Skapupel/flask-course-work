...
⚠️Для початку створіть username для вашого календаря⚠️.
За допомогою команди /username ви можете встановити username.
Використовуйте латинські літери, цифри та знаки пунктуації.
username не може містити пробіли.

Коли ви створили username, можете прописати команду /help.
...
username_already_exists = '''Вибачте, але цей username вже зайнятий.
Виберіть інший username.

Використовуйте команду /username для встановлення username.
Використовуйте латинські літери, цифри та знаки пунктуації.
username не може містити пробіли.'''
